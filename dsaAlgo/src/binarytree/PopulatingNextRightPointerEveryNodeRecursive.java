...
public class PopulatingNextRightPointerEveryNodeRecursive {
    public Node connect(Node root) {
        ...
        if(root.right!=null){
            connectPrevNext(root.right, root.next);
        }

        if(root.right==null && root.left!=null){
            connectPrevNext(root.left, root.next);
        }
    ...
    public void connectPrevNext(Node prev, Node nxt){
        while(nxt!=null){
            if(nxt.left!=null){
                prev.next = nxt.left;
                break;
